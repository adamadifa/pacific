<?php if ($kode_akun == "2-1200") { ?>
  ...
  foreach ($pembelian as $key => $d) {
    ...
    $totalkredit  = $totalkredit + $d->totalkredit;
  ...
  ?>
    <tr style="background-color:<?php echo $color; ?>">
      ...
      <td><?php echo "Hutang Dagang"; ?></td>
      <td align="center" class="str"><?php echo $kode_akun; ?></td>
      <td align="right"></td>
      <td align="right"><?php echo number_format($d->totalkredit); ?></td>
    </tr>
  <?php } ?>
...
<?php } else { ?>
  ...
  $totaldebet     = 0;
  $totalkredit    = 0;
  foreach ($detailpembelian as $key => $d) {

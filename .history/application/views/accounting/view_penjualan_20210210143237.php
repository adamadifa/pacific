<?php if ($kode_akun == "1-1401") { ?>
  ...
  <tr style="font-size:30;">
    ...
    <th style="text-align: right;"><?php echo number_format($total - $totalretur['total'], 2); ?></th>
    <th><?php echo 0; ?></th>
  </tr>
...
<?php } else if ($kode_akun == "4-2101") { ?>
  ...
  ?>
    <tr style="font-size:12;background-color: <?php echo $color; ?>;">
      ...
      <td><?php echo $d->no_retur_penj; ?></td>
      ...
      <td>
        <?php if (empty($d->ceknobukti)) { ?>
          <a href="#" class="btn btn-success btn-sm tambah" data-sumber="Retur Penjualan" data-nobukti="<?php echo $d->ceknobukti; ?>" data-noref="<?php echo $d->no_retur_penj; ?>"><i class="fa fa-plus"></i></a>
        <?php } else { ?>
          <a href="#" class="btn btn-danger btn-sm hapus" data-nobukti="<?php echo $d->ceknobukti; ?>"><i class="fa fa-close"></i></a>
          <?php
          if ($d->total + $d->potistimewa != $d->debet) {
          ?>
            <a href="#" class="btn btn-primary btn-sm refresh" data-nobukti="<?php echo $d->ceknobukti; ?>" data-noref="<?php echo $d->no_retur_penj; ?>"><i class=" fa fa-refresh"></i></a>
          <?php
          }
          ?>
...
<?php } else if ($kode_akun == "4-2202") { ?>
  <?php
  $no = 1;
  $total = 0;
  foreach ($penypenjualan as $dey => $d) {
    $total += $d->total;
    if (empty($d->ceknobukti)) {
      $color = "";
      $textcolor = "";
  ...
  ?>
    <tr style="font-size:12;background-color: <?php echo $color; ?>;">
      ...
      <td><?php echo $d->tgltransaksi; ?></td>
      <td><?php echo $d->no_fak_penj; ?></td>
      <td>Penyesuaian Penjualan</td>
      <td><?php echo $kode_akun; ?></td>
      <td align="right"><?php echo number_format($d->total, 2); ?></td>
      <td></td>
      <td>
        <?php if (empty($d->ceknobukti)) { ?>
          <a href="#" class="btn btn-success btn-sm tambah" data-sumber="Penyesuaian Penjualan" data-nobukti="<?php echo $d->ceknobukti; ?>" data-noref="<?php echo $d->no_fak_penj; ?>"><i class="fa fa-plus"></i></a>
        <?php } else { ?>
          <a href="#" class="btn btn-danger btn-sm hapus" data-nobukti="<?php echo $d->ceknobukti; ?>"><i class="fa fa-close"></i></a>
          <?php
          if ($d->total + $d->potistimewa != $d->debet) {

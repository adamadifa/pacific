...
class Fsthp extends CI_Controller
{
	...
	function buat_nomor_fsthp()
	{
		...
		$no_bpbj 		= "F" . $kode_produk . "/0" . $shift . $tgl;
		echo $no_bpbj;
	}
	...
	function hapus()
	{
		...
		$no_mutasi = $this->uri->segment(3) . "/" . $this->uri->segment(4) . "/" . $this->uri->segment(5) . "/" . $this->uri->segment(6) . "/" . $this->uri->segment(7);
		$hal 			 = $this->uri->segment(8);
	...
	function approve_fsthp()
	{
		...
		$no_fsthp = $this->uri->segment(3) . "/" . $this->uri->segment(4) . "/" . $this->uri->segment(5) . "/" . $this->uri->segment(6) . "/" . $this->uri->segment(7);
		//echo $no_fsthp;
		//die;

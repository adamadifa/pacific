        ...
        <div>
            ...
            <table class="datatable3">
                ...
                <tbody>
                    ...
                    foreach ($listtransfer as $t) {
                        ...
                        if ($t->girotocash == "1") {
                            $totalgirototransfer    = $totalgirototransfer + $t->jumlah;
                            $colorgirototransfer = "yellow";
                        } else {
                    ...
                    ?>
                        <tr bgcolor="<?php echo $colorgirototransfer; ?>">
                            ...
                            <td>
                                <?php
                                if ($t->girotocash == "1") {
                                    echo "Penggantian Giro ke Transfer";
                                }
                                ?>
                            </td>
                        </tr>
            ...
            <div>
                ...
                <div>
                    ...
                    <?php
                    $totalsummary = $totaltunai + $totaltitip + $totalpelunasan + $totalgiro + $totaltransfer - $totalgirotocash - $totalgirototransfer;
                    ?>
                    <table class="datatable3">

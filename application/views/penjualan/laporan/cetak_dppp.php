	...
	<tbody>
		...
		?>
			<tr style="font-size:14px; font-weight:bold">
				...
				<td align="right"><?php if (!empty($d->target_tahun)) {
														echo uang($d->target_tahun);
													} ?></td>
				<td align="right"><?php if (!empty($d->target_bulan)) {
														echo uang($d->target_bulan);
													} ?></td>
				<td align="right"><?php if (!empty($d->realisasibulanberjalan / $d->isipcsdus)) {
														echo persentase($d->realisasibulanberjalan / $d->isipcsdus);
													} ?></td>
				<td align="right">
					<?php
					if ($tahun <= 2019) {
						if (!empty($d->realisasimanual / $d->isipcsdus)) {
							echo persentase($d->realisasimanual / $d->isipcsdus);
						}
					} else {
						if (!empty($d->realisasibulanberjalanlast / $d->isipcsdus)) {
							echo persentase($d->realisasibulanberjalanlast / $d->isipcsdus);
						}
					}

					?>
				</td>
				<td align="right"><?php if (!empty($achbulanini)) {
														echo persentase($achbulanini);
													} ?> %</td>
				<td align="right"><?php if (!empty($grwbulanini)) {
														echo persentase($grwbulanini);
													} ?> %</td>
				<td align="right"><?php if (!empty($d->target_sampaibulan)) {
														echo uang($d->target_sampaibulan);
													} ?></td>
				<td align="right"><?php if (!empty($d->realisasisampaibulanberjalan / $d->isipcsdus)) {
														echo persentase($d->realisasisampaibulanberjalan / $d->isipcsdus);
													} ?></td>
				<td align="right">
					<?php
					if ($tahun <= 2019) {
						if (!empty($d->realisasimanualsampaibulanini / $d->isipcsdus)) {
							echo persentase($d->realisasimanualsampaibulanini / $d->isipcsdus);
						}
					} else {
						if (!empty($d->realisasisampaibulanberjalanlast / $d->isipcsdus)) {
							echo persentase($d->realisasisampaibulanberjalanlast / $d->isipcsdus);
						}
					}

					?>
				</td>
				<td align="right"><?php if (!empty($achsampaibulan)) {
														echo persentase($achsampaibulan);
													} ?> %</td>
				<td align="right"><?php if (!empty($grwsampaibulanini)) {
														echo persentase($grwsampaibulanini);
													} ?> %</td>
				<td></td>
			</tr>
		<?php } ?>

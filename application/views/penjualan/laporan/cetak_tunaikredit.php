	...
	<tbody>
		...
		?>
			<tr>
				...
				<td align="center"><?php if ($jmldust != 0) {
															echo uang($jmldust);
														} else {
															echo "";
														} ?></td>
				<td align="center"><?php if ($jmlpackt != 0) {
															echo uang($jmlpackt);
														} else {
															echo "";
														} ?></td>
				<td align="center"><?php if ($jmlpcst != 0) {
															echo uang($jmlpcst);
														} else {
															echo "";
														} ?></td>
				<td align="right"><?php if ($subtotalt != 0) {
														echo uang($subtotalt);
													} else {
														echo "";
													} ?></td>

				<td align="center"><?php if ($jmldusk != 0) {
															echo uang($jmldusk);
														} else {
															echo "";
														} ?></td>
				<td align="center"><?php if ($jmlpackk != 0) {
															echo uang($jmlpackk);
														} else {
															echo "";
														} ?></td>
				<td align="center"><?php if ($jmlpcsk != 0) {
															echo uang($jmlpcsk);
														} else {
															echo "";
														} ?></td>
				<td align="right"><?php if ($subtotalk != 0) {
														echo uang($subtotalk);
													} else {
														echo "";
													} ?></td>

				<td align="center"><?php if ($jmldusall != 0) {
															echo uang($jmldusall);
														} else {
															echo "";
														} ?></td>
				<td align="center"><?php if ($jmlpackall != 0) {
															echo uang($jmlpackall);
														} else {
															echo "";
														} ?></td>
				<td align="center"><?php if ($jmlpcsall != 0) {
															echo uang($jmlpcsall);
														} else {
															echo "";
														} ?></td>
				<td align="right"><?php if ($subtotalall != 0) {
														echo uang($subtotalall);
													} else {
														echo "";
													} ?></td>
			</tr>

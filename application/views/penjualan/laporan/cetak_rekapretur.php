...
?>
  ...
  <table class="datatable3" style="width:150%" border="1">
    ...
    <tbody>
     ...
     <td align="right" >' . qty($qtytotalSP8) . '</td>
    ...
    <tfoot>
      <tr bgcolor="#ec8585" style="font-weight:bold">
        ...
        <td align="right"><?php echo qty($grandtytotalSP8); ?></td>
        <td align="right"><?php echo uang($grandtotalSP8); ?></td>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="text-align:right; font-weight:bold"><?php if (!empty($grandtotalpenyesuaian)) {
                                                          echo qty($grandtotalpenyesuaian);
                                                        } ?></td>
      </tr>
      <tr>
        <td>AVERAGE</td>

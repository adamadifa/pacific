  ...
  <div class="row">
    <div class="col-md-10 col-xs-12">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>pembelian/returproduksi" autocomplete="off">
            <div class="mb-3">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="input-icon">
                    <input id="tgl_retur" type="date" value="<?php echo $tgl_retur; ?>" placeholder="Tanggal" class="form-control" name="tgl_retur" />
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo DateToIndo2($d['tgl_approve_gb']); ?></td>
                    <td><?php if($d['tgl_approve_pemb'] != ''){ echo DateToIndo2($d['tgl_approve_pemb']); }else{ echo ""; } ?></td>
    ...
    <div class="col-md-2">
      <?php $this->load->view('menu/menu_pembelian_administrator.php'); ?>
    </div>
  </div>
</div>
...
<script type="text/javascript">
  $(function() {
    ...
    $('.detail').click(function(e) {
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo base_url(); ?>pembelian/detail_returproduksi',
        data: {
          nobukti: nobukti
        },
        cache: false,

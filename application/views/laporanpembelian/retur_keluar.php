          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header bg-dark text-white">
                <h4 class="card-title">Laporan Retur Keluar</h4>
              </div>
              <div class="card-body">
                <form class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>laporanpembelian/cetak_retur_keluar" target="_blank">
                  ...
                  <div class="form-group mb-3">
                    <select class="form-select selectoption" id="barang" name="barang" data-error=".errorTxt1" data-live-search="true">

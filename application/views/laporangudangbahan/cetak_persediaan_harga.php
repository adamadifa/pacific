          ...
          <td align="center">
            <?php if (!empty($d->qtypemb1)) {
              if($d->satuan != 'Liter'){
                ...
                $hargapembliter = ($d->qtypemb2*$hargakilo) * 1000;
                echo uang($hargapembliter);
              }
            }
            ?>
          </td>
          <td align="center">
            <?php if (!empty($d->qtypemb1)) {
              if($d->satuan != 'Liter'){
                ...
                echo uang($d->totalharga / ($hargapembliter));
              }
            }else{
              echo "";
            }
          ...
          <td align="center">
            <?php if (!empty($d->qtypemb1)) {
              if($d->satuan != 'Liter'){
                ...
                $jmlhliter = $d->totalharga / $hargapembliter;
                echo uang($jmlhliter * $hargapembliter);
              }
            }else{
              echo "";
            }
          ...
          <td align="center">
            <?php if (!empty($d->qtyseas3)) {
              if($d->satuan != 'Liter'){
                ...
                $hargapembliter = ($d->qtyseas4*$hargakilo) * 1000;
                echo uang($hargapembliter);
              }
            }
            ?>
            ...
            <?php if (!empty($d->qtyseas3)) {
              if($d->satuan != 'Liter'){
                ...
                if ($d->qtypemb2 == '' || $d->qtypemb2 == '0' || $d->qtypemb2 == NULL) {
                  ...
                  $hargapembliter = ($d->qtypemb2*$hargakilo) * 1000;
                  $jmlhliterpemb = $d->totalharga / $hargapembliter;
                  
                  echo uang($jmlhliterpemb * $hargapembliter);
                }
              }
            }else{
              echo "";
          ...
          <td align="center">
            <?php if (!empty($d->qtyseas3)) {
              if($d->satuan != 'Liter'){
                ...
                echo uang($hargapembliter*$hargakeluarberat);
              }
            }
            ?>
          </td>

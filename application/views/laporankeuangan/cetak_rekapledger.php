  ...
  <tbody>
    ...
    ?>
      <tr>
        ...
        <td align="right"><?php if ($r->debet != 0) {
                            echo uang($r->debet);
                          } ?></td>
        <td align="right"><?php if ($r->kredit != 0) {
                            echo uang($r->kredit);
                          } ?></td>
      </tr>
    <?php
    ...
    <tr bgcolor="#024a75" style="color:white; font-size:12;">
      ...
      <th style='text-align:right'><?php if ($totaldebet != 0) {
                                      echo uang($totaldebet);
                                    } ?></th>
      <th style='text-align:right'><?php if ($totalkredit != 0) {

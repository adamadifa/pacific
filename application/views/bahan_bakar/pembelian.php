  ...
  <div class="row">
    <div class="col-md-10 col-xs-12">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>bahan_bakar/pembelian" autocomplete="off">
            <div class="mb-3">
...
<script type="text/javascript">
  $(function() {
    ...
    $('.detail').click(function(e) {
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo base_url(); ?>bahan_bakar/detail_pembelian',
        data: {
          nobukti: nobukti
        },
        cache: false,

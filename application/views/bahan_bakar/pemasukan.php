                ...
                ?>
                  <tr>
                    ...
                    <td width="10px">
                      ...
                      <a href="#" data-href="<?php echo base_url(); ?>bahan_bakar/hapuspemasukan/<?php echo $nobukti; ?>" class="btn btn-sm btn-danger hapus">Hapus</a>
                    </td>
                  </tr>
                <?php
                  $no++;
...
<script type="text/javascript">
  $(function() {
    ...
    $('.detail').click(function(e) {
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo base_url(); ?>bahan_bakar/detail_pemasukan',
        data: {
          nobukti: nobukti
        },
        cache: false,

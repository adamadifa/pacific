  ...
  <div class="row">
    <div class="col-md-10 col-xs-12">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>bahan_bakar/pengeluaran" autocomplete="off">
            <div class="mb-3">
          ...
          <a href="<?php echo base_url(); ?>bahan_bakar/input_pengeluaran" class="btn btn-danger mb-3">Tambah Data</a>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="#" data-href="<?php echo base_url(); ?>bahan_bakar/hapuspengeluaran/<?php echo $nobukti; ?>" class="btn btn-sm btn-danger hapus">Hapus</a>
                    </td>
                  </tr>
                <?php
                  $no++;
...
<script type="text/javascript">
  $(function() {
    ...
    $('.detail').click(function(e) {
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo base_url(); ?>bahan_bakar/detail_pengeluaran',
        data: {
          nobukti: nobukti
        },
        cache: false,
